...
export async function POST(request: Request) {
  ...
  const chain = typeof payload.chain === "string" ? payload.chain.trim().toLowerCase() : "solana";
  ...
  return NextResponse.json({
    message: `Wallet linked for ${chain}. You can use it for paid job payouts and withdrawals.`,
  });
}
